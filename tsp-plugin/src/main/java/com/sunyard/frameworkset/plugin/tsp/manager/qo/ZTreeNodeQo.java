...
public class ZTreeNodeQo {
	...
	private List<ZTreeNodeQo> children;
	...
	public ZTreeNodeQo (String tId, String name, boolean isParent) {
		super ();
		this.tId = tId;
		this.name = name;
	...
	public ZTreeNodeQo (String tId, String name, boolean isParent, String url) {
		super ();
		this.tId = tId;
		this.name = name;
		this.isParent = isParent;
	...
	public List<ZTreeNodeQo> getChildren () {
		return children;
	}

	public void setChildren (List<ZTreeNodeQo> children) {
	...
	/**
	 * @param needSplitPage the needSplitPage to set
	 */
	...
	public String toString () {
		return "ZTreeNodeVo [id=" + id + ", tId=" + tId + ", parentId="
	...
	public String getJobConfigType () {
		return jobConfigType;
	}

	public void setJobConfigType (String jobConfigType) {
