...
import com.sunyard.frameworkset.plugin.tsp.manager.entity.jobconfig.KjbJobConfig;
...
import com.sunyard.frameworkset.plugin.tsp.manager.vo.job.KjbJobVo;
...
public class KjbJobConfigVo extends JobConfigVo {
	...
	@JobDesc(desc = "作业文件名", isNullAble = false)
	private String jobs;
